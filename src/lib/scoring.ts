...
export const PIPELINE_STAGES: {
  ...
  { status: "new",            label: "New Inquiry",           emoji: "✨", bg: "#eff6ff", color: "#2563eb", border: "#dbeafe", description: "Just came in — no action taken yet" },
  { status: "contacted",      label: "Awaiting Response",     emoji: "📤", bg: "#fffbeb", color: "#d97706", border: "#fde68a", description: "Outreach sent — waiting for reply" },
  { status: "replied",        label: "Qualified · Ready to Book", emoji: "✅", bg: "#f0fdf4", color: "#16a34a", border: "#bbf7d0", description: "Lead engaged — ready to schedule appointment" },
  { status: "follow_up_sent",    label: "Follow-Up Sent",        emoji: "🔄", bg: "#fff7ed", color: "#ea580c", border: "#fed7aa", description: "Follow-up message sent — awaiting response" },
  { status: "project_submitted", label: "Intake Submitted",       emoji: "📋", bg: "#faf5ff", color: "#7c3aed", border: "#ddd6fe", description: "Patient submitted intake form & details" },
  { status: "booked",            label: "Appointment Scheduled",  emoji: "🗓️", bg: "#ecfeff", color: "#0891b2", border: "#a5f3fc", description: "Appointment confirmed — goal achieved" },
];
