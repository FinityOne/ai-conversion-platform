    ...
    <div style={{ background: BG, minHeight: "100vh" }}>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  fontSize: 15,
                  border: isGetLeads && !active ? "1px solid rgba(234,88,12,0.18)" : "1px solid transparent",
              ...
              >
                ...
                {label}
                {isGetLeads && !active && (
                  <span style={{ marginLeft: "auto", fontSize: 10, fontWeight: 800, padding: "2px 7px", borderRadius: 20, background: "rgba(234,88,12,0.12)", color: ORANGE }}>
                    New
                  </span>
                )}
              </Link>
        ...
        <div style={{ padding: "14px 12px", borderTop: `1px solid ${BORDER}` }}>
          ...
          {plan ? (() => {
            ...
            <Link href="/onboarding" style={{ textDecoration: "none", display: "block", marginBottom: 8 }}>
              <div style={{ padding: "10px 12px", borderRadius: 10, background: "rgba(234,88,12,0.06)", border: "1px solid rgba(234,88,12,0.18)", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 10px", borderRadius: 10, background: BG, marginBottom: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg,#ea580c,#f97316)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 13, fontWeight: 700 }}>
              {initials}
            </div>
      ...
      >
        <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{ width: 30, height: 30, borderRadius: 8, background: "linear-gradient(135deg,#ea580c,#f97316)", display: "flex", alignItems: "center", justifyContent: "center" }}>
