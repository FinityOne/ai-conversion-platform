          ...
          <div className="text-center">
            <div className="mx-auto mb-6 flex items-center justify-center"
              style={{ width: 72, height: 72, borderRadius: "50%",
                ...
                boxShadow: "0 8px 24px rgba(40,96,176,0.28)" }}>
            ...
            <p className="text-sm mb-2" style={{ color: MUTED, lineHeight: 1.7 }}>We sent a password reset link to</p>
            ...
            <button
              ...
              style={{ color: SAPPHIRE, background: "none", border: "none", cursor: "pointer", fontWeight: 600, fontSize: 14 }}
            >
          ...
          <>
            <div className="mb-8 text-center">
              <div className="mx-auto mb-5 flex items-center justify-center"
                ...
                <i className="fa-solid fa-lock-open" style={{ fontSize: 20, color: SAPPHIRE }} />
              </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                ...
                <input
                  type="email" inputMode="email" placeholder="you@practice.com"
