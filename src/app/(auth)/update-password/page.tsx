...
const baseInput: React.CSSProperties = {
  ...
  borderRadius: "14px", color: TEXT, fontSize: "17px",
    ...
    <div className="flex flex-col gap-2">
      ...
      <div style={{ position: "relative" }}>
        ...
        <button type="button" onClick={() => setVisible(v => !v)} tabIndex={-1}
          style={{ position: "absolute", right: 16, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: MUTED, fontSize: 16 }}>
        ...
        {done ? (
          ...
          <>
            <div className="mb-8 text-center">
              <div className="mx-auto mb-5 flex items-center justify-center"
                style={{ width: 52, height: 52, borderRadius: 14,
                  background: "rgba(40,96,176,0.08)", border: "1px solid rgba(40,96,176,0.2)" }}>
                <i className="fa-solid fa-lock" style={{ fontSize: 20, color: SAPPHIRE }} />
              </div>
              <h1 className="text-2xl font-black mb-2" style={{ color: TEXT }}>Set a new password</h1>
              <p className="text-sm" style={{ color: MUTED, lineHeight: 1.6 }}>Choose something strong — at least 8 characters.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <PasswordInput label="Confirm new password" value={confirm} onChange={setConfirm} placeholder="Re-enter password" autoComplete="new-password" />

              {mismatch && (
                <p style={{ margin: "-8px 0 0", fontSize: 13, color: "#dc2626" }}>Passwords don&apos;t match</p>
              )}
